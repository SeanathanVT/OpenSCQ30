...
where
    T: Has<
        ...
        + Has<a3953::structures::IsHearIdInitialized>
        + Clone
        + Send
        + Sync,
{
    async fn move_to_state(
        ...
        let is_hear_id_initialized: a3953::structures::IsHearIdInitialized = *target_state.get();

        self.packet_io
            .send_with_response(&a3953::packets::set_equalizer_configuration(
                target_eq,
                &target_hear_id,
